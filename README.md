...
- 筛选（全部 / 想法 / 待办）+ 标题/正文搜索；未完成优先 + 创建时间倒序
- 数据随 JSON 备份一起导出 / 导入

**通用**
- 单窗口四页签（脚本 / 项目 / 备忘 / 设置）、模糊搜索、卡片与列表两种视图
- 浅色 / 深色主题（跟随系统或手动切换）
